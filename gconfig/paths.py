...
TILEMAP_SCENE_DIR = "tilemapscenes"
ACTOR_DIR = "actors"
...
TILEMAP_SCENE_FULL_PATH = [RESOURCE_PATH, CODE_PATH, TILEMAP_SCENE_DIR]
FULL_ACTOR_PATH = [RESOURCE_PATH, CODE_PATH, ACTOR_DIR]
...
TILEMAP_SCENE_EXTENSION = ".tiledscene"
