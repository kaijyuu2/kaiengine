...
FOCUS_EVENT_KEYS = (CONFIRM_KEY, CONFIRMHOLD_KEY, CANCEL_KEY, CANCELHOLD_KEY, MOVEUP_KEY, MOVEUPHOLD_KEY, MOVEDOWN_KEY, MOVEDOWNHOLD_KEY, MOVERIGHT_KEY, MOVERIGHTHOLD_KEY, MOVELEFT_KEY, MOVELEFTHOLD_KEY)
